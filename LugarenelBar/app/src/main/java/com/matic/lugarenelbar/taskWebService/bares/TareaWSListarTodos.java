 ...
 */
public class TareaWSListarTodos extends AsyncTask<String, Integer, String[]> {
    ...
    protected String[] doInBackground(String... params) {
        ...
        try {
            ...
            bares = new String[respJSON.length()];
            ...
            for (int i = 0; i < respJSON.length(); i++) {
                ...
                bares[i] = "IdBar:" + idBar + "\nNombre Legal: " + nombreLegal + "\nDirección: " + calle + " " + nroCalle + "\nTeléfoono: " + telefono + "\nMesas libres: " + mesasLibres;
